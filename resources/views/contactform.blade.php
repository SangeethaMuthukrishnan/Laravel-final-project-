    ...
    <div class="wrapper wrapper--w790">
        @if(session('contact_success_message'))
            <div class="alert alert-success">
                {{session('contact_success_message')}}
            </div>
        @endif
        <a href="{{url('/register')}}" style="text-decoration: none;margin-left: 20px; color:white;font-size: 20px;">Register</a>
        <a href="{{url('/login-page')}}" style="text-decoration: none;margin-left:30px;color:white;font-size: 20px;">Login</a>
